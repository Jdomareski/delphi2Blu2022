...
var
  ...
  begin
    try
      ...
      xPessoa.Nome := inputbox('Nome do indivíduo', 'Digite Seu Nome','0');
      xPessoa.Data := strToDate(inputbox('Data de Nascimento do indivíduo',
       'Digite Seu Data de Nascimento','0'));
      xPessoa.Altura := StrTofloat(inputbox('Altura do indivíduo',
       'Digite Sua Altura','0'));
