...
var
  ...
  begin
    ...
    frm_LB_Saida.Caption := ('O valor de cada uma das 5 parcelas é de R$ ' + formatcurr('#,##0.00', xVpar));
    //frm_LB_Saida.Caption := ('O valor de cada uma das ' + floatTostr(xqParc) +  ' parcelas é de R$ ' + floatToStr(xVpar))
  end;
